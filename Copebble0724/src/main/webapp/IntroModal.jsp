   ...
   <main>
      ...
      <div id="modal1" class="modalBack">
         <div class="modal-content">
            ...
            <input type="password" name="pw" id="loginPW"
               placeholder="  비밀번호를 입력하세요"> <input type="submit"
               value="로그인" id="login_btn"> <input type="submit"
               value="카카오 로그인" id="kakao-login-btn">
            <hr class="hr">
      ...
      <div id="modal2" class="modalBack">
         <div class="modal-content">
            ...
            <p style="margin-bottom: 1%; font-weight: bold;">비밀번호</p>
            <input type="password" name="PW" id="joinPW"
            ...
            <input type="text" name="NAME" id="joinNAME"
               placeholder="  이름을 입력하세요"> <input type="submit"
               value="회원가입" id="join_btn">
            <!-- 회원가입 ajax -->
      ...
      <div id="modal3" class="modalBack">
         <div class="modal-content">
            ...
            <br>
            <h2>회원이 되셨습니다</h2>
            <a href="FamilyKey.jsp"> <input type="submit" value="패밀리키 등록하기"
               id="goFamily">
            </a> <a href="Main.jsp"> <input type="submit" value="withDAY 이용하기"
               id="goMain">
            </a>
         </div>
      </div>
                           ...
                           .ajax({
                              ...
                              success : function(result) {
                                 ...
                                 if (result == null) {
                                    ...
                                    // 회원가입 성공 시
                                    document
                                          .getElementById("modal3").style.display = "block"; //회원가입 완료 모달창
                                    document
                                          .getElementById("join_name").innerHTML = result
                                          + "님,"; //회원가입 완료 모달창
                           ...
                           .ajax({
                              ...
                              success : function(result) {
                                 ...
                                 if (result == "오라클 로그인 연결 실패") {
                                    alert("등록되지 않은 회원입니다");
                                    document
                                          .getElementById("modal2").style.display = "block"; // 회원가입 모달창
                                 } else {
