   ...
   <main class="fullmain">
      ...
      <div id="checkboxContainer">
         <div id="eventWhose">
            ...
            <br>
            <span class=whattodo " style="background-color: #fff7076b;">🔎집안일
            ...
            <br> <br>
            <span class="who" style="background-color: #00ff1414;">✔담당자
               선택</span> <br> <input type="button" value="👩"
               onclick="insertValue(' 👩 ')"> <input type="button"
               value="🧑" onclick="insertValue(' 🧑 ')"> <br> <br>
            <span class="chooseline" style="background-color: #ff5e0029;">📏구분선 선택</span> <br> <input
               type="button" value="_" onclick="insertValue(' _ ')"> <input
               type="button" value="/" onclick="insertValue(' / ')"> <br>
            <br>
            <span class="whenwedo" style="background-color: #e7b9ff52;">📆마감 기한 선택</span><br> <input
